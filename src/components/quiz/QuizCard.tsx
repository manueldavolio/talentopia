  ...
  return (
    <div className="rounded-3xl bg-white/10 border border-white/20 p-6 animate-fade-in">
      <div className="flex flex-wrap gap-2 mb-4">
        ...
        <span className="rounded-full bg-white/10 px-3 py-1 text-xs">{question.topic}</span>
      </div>
      ...
      {showResult && (
        <p className="mt-4 rounded-2xl bg-blue-500/20 p-4 text-sm border border-blue-400/30">
